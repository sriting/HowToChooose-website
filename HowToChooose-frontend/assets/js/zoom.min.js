(function(e) {
    ...
    function a() {
        ...
        if (t.length == 0) t = e(".gallery_img li:last-child, .gallery_img_pro li:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent("li").next();
        if (t.length == 0) t = e(".gallery_img li:first-child, .gallery_img_pro li:last-child");
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".gallery_img li a, .gallery_img_pro li a").length == 1) e(".gallery_img li a, .gallery_img_pro li a")[0].addClass("zoom");
        e(".zoom, .gallery_img li a, .gallery_img_pro li a").on("click", u)
    })(); (function() {
